...
def train_baseline(model, dataset, tokenizer, probe_input_ids, n_steps=5000, lr=1e-3,
...
def main():
    ...
    train_baseline(
        ...
        n_steps=5000,
        lr=1e-3,  # i added 1e-3 because i heard its the best any comments about a better lr
        warmup_steps=200,
        batch_size=64,
        weight_decay=0.01,
        grad_clip=1.0,
