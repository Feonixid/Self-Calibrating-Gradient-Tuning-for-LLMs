...
The benchmark shows SGT training a randomly initialized 70.5M parameter model on WikiText-103 for 5000 steps. No pre-trained weights were used, and the controller adapted entirely on its own.
