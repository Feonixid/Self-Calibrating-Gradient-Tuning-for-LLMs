...
def train_baseline(model, dataset, tokenizer, probe_input_ids, n_steps=5000, lr=0.01,
...
def main():
    ...
    print("\nInitializing Custom ~70.5M LLaMA Architecture from scratch")
    ...
    train_baseline(
        ...
        n_steps=5000,
        lr=0.01,  # 0.01 is the well-studied sweet spot for SGD+Momentum on ~70M transformers
        warmup_steps=200,
        batch_size=64,
        weight_decay=0.01,
        grad_clip=1.0,
